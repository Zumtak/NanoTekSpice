...
// ====================== Component 4081 : pin 3 ======================

TEST_CASE("Simple compute 4081 component : output 3 -> (1 & 1) = 1")
{
    ...
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 3 -> (1 & 0) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompTrue>("t1");
...
TEST_CASE("Simple compute 4081 component : output 3 -> (0 & 1) = 0")
{
...
TEST_CASE("Simple compute 4081 component : output 3 -> (0 & 0) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompFalse>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompFalse>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
// ====================== Component 4081 : pin 4 ======================

TEST_CASE("Simple compute 4081 component : output 4 -> (1 & 1) = 1")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompTrue>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompTrue>("t2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 4 -> (1 & 0) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompTrue>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompFalse>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 4 -> (0 & 1) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompFalse>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompTrue>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 4 -> (0 & 0) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompFalse>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompFalse>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
// ====================== Component 4081 : pin 10 ======================

TEST_CASE("Simple compute 4081 component : output 10 -> (1 & 1) = 1")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompTrue>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompTrue>("t2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 10 -> (1 & 0) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompTrue>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompFalse>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 10 -> (0 & 1) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompFalse>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompTrue>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 10 -> (0 & 0) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompFalse>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompFalse>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
// ====================== Component 4081 : pin 11 ======================

TEST_CASE("Simple compute 4081 component : output 11 -> (1 & 1) = 1")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompTrue>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompTrue>("t2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 11 -> (1 & 0) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompTrue>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompFalse>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 11 -> (0 & 1) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompFalse>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompTrue>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
...
TEST_CASE("Simple compute 4081 component : output 11 -> (0 & 0) = 0")
{
    std::unique_ptr<nts::IComponent> i1 = std::make_unique<nts::CompFalse>("t1");
    std::unique_ptr<nts::IComponent> i2 = std::make_unique<nts::CompFalse>("f2");
    std::unique_ptr<nts::IComponent> component = std::make_unique<nts::Comp4081>("4081");
