...
TEST_CASE("Test component 4081 integrity and basic methods")
{
    nts::Comp4081 component("my_component");
...
TEST_CASE("Simple OR with output 3 : 1 & 0 => 0")
{
    nts::Comp4081 component("my_component");
...
TEST_CASE("Simple OR with ouput 3 : 0 & 1 => 0")
{
    nts::Comp4081 component("my_component");
...
TEST_CASE("Simple OR with output 4 : 1 & 0 => 0")
{
    nts::Comp4081 component("my_component");
...
TEST_CASE("Simple OR with ouput 4 : 0 & 1 => 0")
{
    nts::Comp4081 component("my_component");
...
TEST_CASE("Simple OR with output 10 : 1 & 0 => 0")
{
    nts::Comp4081 component("my_component");
...
TEST_CASE("Simple OR with ouput 10 : 0 & 1 => 0")
{
    nts::Comp4081 component("my_component");
...
TEST_CASE("Simple OR with output 11 : 1 & 0 => 0")
{
    nts::Comp4081 component("my_component");
...
TEST_CASE("Simple OR with ouput 11 : 0 & 1 => 0")
{
    nts::Comp4081 component("my_component");
